...
CHAT_THEME = {
    ...
    "dark": {
        ...
        "banner_fg": "#C7C7C7",
        "first_msg_bg": "rgba(30,90,200,0.25)",
        "first_msg_alt_bg": "rgba(30,90,200,0.20)",
        "mod_bg": "rgba(30,180,80,0.25)",
        "mod_alt_bg": "rgba(30,180,80,0.20)",
        "vip_bg": "rgba(255,100,168,0.25)",
        "vip_alt_bg": "rgba(255,100,168,0.20)",
        "partner_bg": "rgba(140,40,200,0.25)",
        "partner_alt_bg": "rgba(140,40,200,0.20)",
        "broadcaster_bg": "rgba(200,40,40,0.30)",
        "broadcaster_alt_bg": "rgba(200,40,40,0.25)",
    },
    "light": {
        "text_color": "#2e2e2e",
        ...
        "vip_bg": "rgba(255,100,168,0.20)",
        "vip_alt_bg": "rgba(255,100,168,0.15)",
